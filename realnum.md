...
---------------|:----------------------------------
`{r{,max}}`  | 区间 (-<span style="font-size: 2em;">∞</span>, max] ，表示所有 **小于等于** max 的实数，max 可以为负数
`{r{min,}}`  | 区间 [min, +<span style="font-size: 2em;">∞</span>) ，表示所有 **大于等于** min 的实数，min 可以为负数
`{r{,}}`     | 区间 (-<span style="font-size: 2em;">∞</span>, +<span style="font-size: 2em;">∞</span>) ，表示所有实数，包含所有正负数和 0
